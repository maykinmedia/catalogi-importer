...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "importer"),
        "USER": os.getenv("DB_USER", "importer"),
        "PASSWORD": os.getenv("DB_PASSWORD", "importer"),
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "importer.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "importer.accounts.backends.UserModelEmailBackend",
