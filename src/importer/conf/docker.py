...
os.environ.setdefault("DB_USER", os.getenv("DB_USER", "importer"))
os.environ.setdefault("DB_NAME", os.getenv("DB_NAME", "importer"))
os.environ.setdefault("DB_PASSWORD", os.getenv("DB_PASSWORD", "importer"))
